...
Label propagation core algorithm used in "constructed_database.py" function: label_new_seq ()
To detect new seqs given the labeled seqs
...
def sum_new_labeled_func(all_seq_func_dict, pre_labeled_seq, quasi_labeled_seq, new_labeled_seq, new_unlabeled_seq, initial_blast_remain_seq_set):
    ...
    summary_df = summary_df.sort_values(by=["Pre_Labeled_Number", "Quasi_Labeled_Number", "New_Labeled_Number"],
...
# main function #
#################
def detect_new_seq_in_community(pre_labeled_seq_fas_path,
                                quasi_labeled_seq_fas_path,
                                pre_labeled_connected_and_indirect_fas_path,
                                initial_blast_seq_from_seed_path,
                                labeled_to_initial_blast_res_path,
                                t1_to_initial_blast_res_path
                                ):
    """
